...
{include file="standard/sidebar.tpl"}
{include file="standard/sys-message.tpl"}
{include file="standard/selector-main.tpl"}
...
{include file="standard/announce-system-unread.tpl"}
{include file="standard/announce-project-all-unread.tpl"}
