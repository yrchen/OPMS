    ...
    <div class="post" style="margin-right:225px;">
      ...
      <blockquote style="margin:0;">
        ...
        <ol>
          ...
          <li><a href="main.php?event=Task&action=ViewTask&id={$project_task->mProjectTask[i].id}&active_project={$smarty.request.active_project}">{$project_task->mProjectTask[i].text}</a></li>
          {/section}
        </ol>
        {else}
